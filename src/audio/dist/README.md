### Auto-generated HTML & Javascript for Cmajor Patch "Euclidean Drum Machine"
...
- `cmaj_Euclidean_Drum_Machine.js` - this is the Javascript wrapper class for the patch, encapsulating its
